...
import com.hcmut.admin.utrafficsystem.tbt.object.DestIcon;
...
import com.hcmut.admin.utrafficsystem.tbt.object.MapView;
import com.hcmut.admin.utrafficsystem.tbt.object.UserIcon;
...
public class TestRenderer implements GLSurfaceView.Renderer {
    ...
    private final DestIcon destIcon;
    ...
    private static class TransformationAnimation {
        ...
        private static TransformationAnimation scale(List<TransformationAnimation> minMax, float t) {
    ...
    public TestRenderer(Context context, double curLon, double curLat, double destLon, double destLat) {
        ...
        destIcon = new DestIcon(config, new Location("dest") {{
            setLatitude(destLat);
    ...
    private void initOpenGL() {
        ...
        config.setTextureShaderProgram(new TextureShaderProgram(config, projectionMatrix, modelViewMatrix));
