...
public class MultisampleConfigChooser implements GLSurfaceView.EGLConfigChooser {
    ...
    public EGLConfig chooseConfig(@NonNull EGL10 gl, @NonNull EGLDisplay display) {
        ...
        EGLConfig config = MultisampleConfigChooser.ConfigData.create(EGL10.EGL_RED_SIZE, RED,
        ...
        config = MultisampleConfigChooser.ConfigData.create(EGL10.EGL_RED_SIZE, RED,
                EGL10.EGL_GREEN_SIZE, GREEN,
                EGL10.EGL_BLUE_SIZE, BLUE,
                EGL10.EGL_ALPHA_SIZE, ALPHA,
                EGL10.EGL_STENCIL_SIZE, STENCIL,
        ...
        config = MultisampleConfigChooser.ConfigData.create(
    ...
    private static final class ConfigData {
        ...
        @NonNull
        private static MultisampleConfigChooser.ConfigData create(int... spec) {
            return new MultisampleConfigChooser.ConfigData(spec);
        }
